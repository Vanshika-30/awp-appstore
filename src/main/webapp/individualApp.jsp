...
<html>
    ...
    <body>
        ...
        <div class="col-lg-9">
            ...
            <img class="card-img-top img-fluid" src='${app.getLogo()}' alt="${app.getName()}" style="width:fit-content;height:auto">
                ...
                <c:if test="${id1!=id2}">
                    <div class="col-lg-4 col-md-6 mb-4">
                      <div class="card h-100">
                        <a href="individualPage.html?id=${appli.getId()}"><img class="card-img-top" src="${appli.getLogo()}" alt="${app.getName()}"></a>
                        <div class="card-body">
                          <h4 class="card-title">
                              <a href="individualPage.html?id=${appli.getId()}"><c:out value="${appli.getName()}"/></a>
                          </h4>
