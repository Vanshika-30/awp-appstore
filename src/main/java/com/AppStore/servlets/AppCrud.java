...
public class AppCrud {
	...
	public boolean insertApp(Application app) throws Exception{
	...
	public boolean deleteApp(int id) throws Exception
	{
	...
	public boolean updateApp(Application app) throws Exception
	{
